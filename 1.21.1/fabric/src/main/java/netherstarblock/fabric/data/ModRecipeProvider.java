package netherstarblock.fabric.data;
...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        offerReversibleCompactingRecipes(RecipeCategory.MISC, exporter, Items.NETHER_STAR, ModBlocks.NETHER_STAR_BLOCK.getItem());
    }
}
